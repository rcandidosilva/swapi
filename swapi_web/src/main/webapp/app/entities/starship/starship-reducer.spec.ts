...
import reducer, { getEntities, getEntity, reset } from './starship.reducer'
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STARSHIP_LIST actions', async () => {
      const arg = {}
    ...
    it('dispatches FETCH_STARSHIP actions', async () => {
      const arg = 42666
