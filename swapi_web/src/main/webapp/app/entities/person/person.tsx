                ...
                {personList && personList.length > 0 ? (
                        ...
                        <tr key={`entity-${i}`} data-cy="entityTable">
                          ...
                          <td className="text-end">
                            <div className="btn-group flex-btn-group-container">
                              <Button tag={Link} to={`/person/${person.uid}`} className="rounded-pill" color="info" size="sm" data-cy="entityDetailsButton">                        
                  ...
                  !loading && (
                    <div className="alert alert-warning">
                      <Translate contentKey="swapiApiApp.person.home.notFound">No People found</Translate>
                    </div>
                  )
                )}
              </div>
